...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to='ecomerce/products/%Y/%m/%d',blank=True)
...
class Team(models.Model):
    img = models.ImageField(upload_to="ecomerce/team/", blank=True)
    ...
    def get_absolute_url(self):
        return reverse('shop:teamsuccess')
